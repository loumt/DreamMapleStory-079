...
public enum ReceivePacketOpcode implements WritableIntValueHolder {
    LOGIN_PASSWORD(0x01),
    SERVER_LIST_REQUEST(0x03),
    CHAR_LIST_REQUEST(0x04),
    CHAR_SELECT(0x06),
    PLAYER_LOGGED_IN(0x07),
    ...
    private ReceivePacketOpcode() {
        this.check = true;
    }

    private ReceivePacketOpcode(int code) {
        this.code = (short) code;
        this.check = false;
    }

    private ReceivePacketOpcode(short code, final boolean CheckState) {
        this.code = code;
        this.check = CheckState;
    }

    private ReceivePacketOpcode(final boolean CheckState) {
        this.check = CheckState;
    }
    ...
    public static String nameOf(short value) {
        for (ReceivePacketOpcode header : ReceivePacketOpcode.values()) {
