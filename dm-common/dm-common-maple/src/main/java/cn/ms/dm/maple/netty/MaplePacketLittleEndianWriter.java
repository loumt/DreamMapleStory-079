package cn.ms.dm.maple.netty;

import cn.ms.dm.maple.constant.MapleType;
...
public class MaplePacketLittleEndianWriter {
    ...
    private static final Charset ASCII = Charset.forName(MapleType.getDefault().getANSI()); // US-ASCII, ISO-8859-1, UTF-8, MS949
    ...
    public final void writeFile(final File file) {
        try {
            ...
            if (offset < bytes.length) {
                System.err.println("无法完整读取文件:" + file.getName());
                return;
            }
