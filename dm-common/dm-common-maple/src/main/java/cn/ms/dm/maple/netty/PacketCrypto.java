...
import cn.ms.dm.maple.utils.BitUtil;
...
/**
 * @author LouMT
 * @name PacketEncryption
 * @date 2025-08-18 14:08
...
public class PacketCrypto {
     ...
     */
    public PacketCrypto(byte iv[], short mapleVersion) {
        try {
    ...
    public String toString() {
        return "IV: " + HexUtil.toString(this.iv);
    }
