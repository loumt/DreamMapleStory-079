package cn.dm.ms.mybatis.handler;
 ...
 */
public class DMEnumCodeHandler extends BaseTypeHandler<BaseEnum> {
     ...
     */
    public DMEnumCodeHandler(Class<BaseEnum> type) {
        if (type == null)
